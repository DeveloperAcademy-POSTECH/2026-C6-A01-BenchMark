...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="ko"><body>
    ...
    <header className="site-header"><Link className="wordmark" href="/" aria-label="쉼, 펴 홈">쉼, 펴<span>이야기가 머무는 자리</span></Link><nav aria-label="주 메뉴"><Link href="/">이야기</Link><Link href="/about">프로젝트 소개</Link></nav></header>
