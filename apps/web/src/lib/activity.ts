...
export const activityNames = ["page_view", "scroll_depth", "active_time", "link_click", "reaction_attempt", "reaction_success", "reaction_failure", "reservation_attempt", "reservation_success", "reservation_failure", "photo_selected", ...cameraActivityNames] as const;
